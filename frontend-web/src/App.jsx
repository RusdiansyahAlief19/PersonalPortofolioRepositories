            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10">
                <div>
                    ...
                    <div className="space-y-4">
                        ...
                        <a href="https://www.linkedin.com/in/rusdiansyah-prasetya-aa80b0227/" target="_blank" rel="noreferrer" className="flex items-center gap-4 text-gray-300 hover:text-jcrea-orange transition-colors group">
                            <div className="w-12 h-12 bg-black/30 rounded-xl flex items-center justify-center group-hover:bg-jcrea-orange/20 transition-colors">
